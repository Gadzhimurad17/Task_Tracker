...
namespace Entities {
TaskComments::TaskComments(unsigned int comment_id_, unsigned int task_id_, unsigned int user_id_,
...
std::string &TaskComments::GetCommentText() const { return comment_text; }
