...
{
void ProjectsRepo::Create(const Entities::Projects &entity)
{
    try
    {
        ...
        txn.exec_params(query, entity.GetProjectId(), entity.GetProjectName(),
...
void ProjectsRepo::Update(const Entities::Projects &entity)
{
    try
    {
        ...
        txn.exec_params(query, entity.GetProjectName(), entity.GetDescription(),
                        entity.GetProjectId());
        txn.commit();
    }
    catch (const pqxx::sql_error &e)
