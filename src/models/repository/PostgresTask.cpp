...
//     }
// }
// Task DatabaseManager::Get(unsigned int task_id){
//     try{
//         pqxx::work tx(*conn);
//         const std::string query=
//                     "SELECT * "
//                     "FROM tasks "
//                     "WHERE task_id=$1 LIMTI 1";

//         const pqxx::result r=tx.exec_params(query,task_id);
...
//     }
// }
// void DatabaseManager::Remove(unsigned int task_id){
//     try{
//         pqxx::work tx(*conn);
//     }
//     catch(const std::exception()& e){
